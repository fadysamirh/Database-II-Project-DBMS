...
public class BPlusConfiguration implements Serializable {
	...
	/**
	 *
	 * Default constructor which initializes all settings to the predefined
	 * defaults.
	 * 
	 * @throws Exception
	 *
...
//    	this.entrySize = 20;
	...
	public BPlusConfiguration(int pageSize, int keySize, int entrySize, int conditionThreshold) {
		basicParams(pageSize, keySize, entrySize);
...
//	}
	...
	private void checkDegreeValidity() {
		if (treeDegree < 2 || leafNodeDegree < 2 || overflowPageDegree < 2 || lookupOverflowPageDegree < 2) {
...
//		return 3;
	...
	public int getMinInternalNodeCapacity() {
		return (int) (Math.ceil((getMaxLeafNodeCapacity() + 1) / 2) - 1);
